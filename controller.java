...
public class controller implements Initializable {
    ...
    public void serialize() throws IOException {
        ...
        svfile = new save(hero.getOrc().getLayoutX(), hero.getOrc().getLayoutY(), coincount, scorecount, ressurect,
                ...
                coincounter.getLayoutX(), scorelLabel.getLayoutX(), p3.getLayoutX(),oflags,ox,oy,tx,ty,bx,by);// weaponflag =0 is shuri
        try {
    ...
    public void init(MouseEvent m) {
        boundary barrier = new boundary(scenePane, 6000, 1, 0, 300);
        // hero = new avatar(scenePane, 50, 50, 100, 205, barrier.gRectangle(),ISLAND1);
        for(int k =0;k<10;k++)
        {
            
        topboundaries.add(new boundary(scenePane, 30, 1, 195 + (400 * k), 230));
                bottomboundaries.add(new boundary(scenePane, 30, 1, 195 + (400 * k), 280));
        ...
        blades.add(blade2);
        blades.add(blade3);
        hero = new avatar(scenePane, 20, 25, 300, 225, barrier.gRectangle(), topboundaries, bottomboundaries, ISLAND1,ISLAND2,coins,blades);

        for (int a =0;a<10;a++)
        {
            
                orcs.add(new orc(scenePane, 60, 60, 195 + (400 * a), 225, hero.getOrc(), ISLAND1, barrier.gRectangle(), shoot_weapon,shoot_weapon2, topboundaries.get(a), bottomboundaries.get(a)));
        ...
        //topboundaries.add(new boundary(scenePane, 30, 1, 645, 230));
        //bottomboundaries.add(new boundary(scenePane, 30, 1, 645, 280));
        // orcs.add();
        //orc = new orc(scenePane, 60, 60, 625, 225, hero.getOrc(), ISLAND1, barrier.gRectangle(), shoot_weapon,
