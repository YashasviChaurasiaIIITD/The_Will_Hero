...
public class m31 implements Initializable {
    ...
    int weaponflag = 0;// -1 is no weapon 0 is shuri 1 is knife
    weapon w1;
    weapon w2;
    ...
    public void serialize() throws IOException {
        ...
        svfile = new save(avatar.getLayoutX(), avatar.getLayoutY(), coincount, scorecount, ressurect, knife, shuri,
                weaponflag, scenePane.getLayoutX(), pane.getLayoutX(), pane2.getLayoutX(), settings.getLayoutX(),
                coincounter.getLayoutX(), scorelLabel.getLayoutX());//
        try {
    ...
    public void play(MouseEvent m2) throws IOException, InterruptedException {
        ...
        scenePane.getChildren().remove(willhero);
    ...
    // public void exitorc() throws IOException {

    // Stage stage;
    // Scene scene;

    // Stop[] stops = new Stop[] { new Stop(0, Color.WHITE), new Stop(1,
    ...
    // AnimationTimer floorcollision = new AnimationTimer() {
    // @Override
    // public void handle(long timestamp) {
    // // checkCollision(avatar,bigorc1);
    // }
    // };
    ...
    // knife = new weapon(scenePane, 20, 20, avatar.getLayoutX(),
    // avatar.getLayoutY());
    // Node KNIFE = knife.getIsl1();
    // KNIFE.relocate(avatar.getLayoutX() + avatar.getBoundsInLocal().getWidth(),
    // avatar.getLayoutY());
    // WeaponNode.add(KNIFE);
    // scenePane.getChildren().add(KNIFE);
    // }
    // };
    ...
    public void init(MouseEvent m) throws ClassNotFoundException, IOException {
        ...
        // scorelLabel.setLayoutX(ldfile.scorecount);
        ...
        // blade3.getwindmill().setRotate(270);
        ...
        Timeline timeline = new Timeline(
                ...
                new KeyFrame(Duration.seconds(20), new KeyValue(rotate2.angleProperty(), 360)));
        Timeline timeline2 = new Timeline(
                new KeyFrame(Duration.ZERO, new KeyValue(rotate3.angleProperty(), 0)),
                new KeyFrame(Duration.seconds(20), new KeyValue(rotate3.angleProperty(), 360)));
        ...
        for (int i = 0; i < 200; i++) {
            ISLAND1.add(new island(scenePane, 184, 143, 195 + (200 * i), 245));
            // if (i % 2 == 0) {
